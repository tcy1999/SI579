...
const explanation = `This is because previously the Celsius temperature was not set as a state variable. \
We need to use useState(...) to let the page rerender after the Celsius temperature value has changed.
`;
