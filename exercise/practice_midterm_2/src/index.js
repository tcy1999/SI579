...
const due = new Date('Wed Nov 17 2021 16:05:00 GMT-0500 (Eastern Standard Time)')
const instructions = `
...
When you are done, upload your code to GitHub and post the link to your code on Canvas (under [the ${SHORT_EXAM_NAME} assignment](${EXAM_LINK})).
`
